...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address senderAddress = ownerOf(_tokenId1);
        address recieverAddress = ownerOf(_tokenId2);
        require(
            msg.sender == senderAddress || msg.sender == recieverAddress,
            "Neither of the tokens belong to the sender."
        );
        //4. Use _transferFrom function to exchange the tokens.
        transferFrom(senderAddress, recieverAddress, _tokenId1);
        transferFrom(recieverAddress, senderAddress, _tokenId2);
    }

    // Implement Task 1 Transfer Stars
    function transferStar(address _to1, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
        require(msg.sender == ownerOf(_tokenId), "Sender is not the owner of tokenId");
